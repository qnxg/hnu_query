...
pub async fn get_person_info(
    ...
    for json_str in json_str_list {
        entries.extend(parse_time!(parse::extract_xgxt_entry(&json_str))?);
    }

    parse_time!(parse::person_info(entries))
}
